  ...
  const ModalContent = () => {
    ...
    return (
      <div className='flex flex-col'>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo tempora molestiae vitae eaque voluptates aspernatur reprehenderit obcaecati doloremque? Doloremque, maxime.</p>
